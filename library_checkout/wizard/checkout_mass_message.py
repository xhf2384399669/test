...
class CheckoutMassMessage(models.Model):
    _name = 'library.checkout.massmessage'
    _description = 'Send Message to Borrowers'
    _logger = logging.getLogger(__name__)

    checkout_ids = fields.Many2one('library.checkout', string='Checkouts')
    ...
    def button_send(self):
        ...
        for checkout in self.checkout_ids:
            checkout.message_post(body=self.message_body, subject=self.message_subject, subtype='mail.mt_comment', )
